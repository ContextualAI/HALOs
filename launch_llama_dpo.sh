...
export CKPT=/scratch/gpfs/ke7953/models/llama3-8B-dpo-${BETA}-${LR}/FINAL
...
python -m eval.sample_for_alpacaeval \$CKPT --gpu_count 2 --output_file outputs/llama3-8b-dpo-${BETA}-${LR}.json
"