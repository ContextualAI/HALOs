...
losses = [{
    "pythia1-4b" : {"ppo": f"{hf_link}_ppo_pythia1-4b", "dpo": f"{hf_link}_dpo_pythia1-4b", "kto": f"{hf_link}_kto_pythia1-4b", "sft": f"{hf_link}_sft_pythia1-4b", "slic": f"{hf_link}_slic_pythia1-4b", "sft+ppo": f"{hf_link}_sft-ppo_pythia1-4b", "sft+dpo": f"{hf_link}_sft-dpo_pythia1-4b", "sft+kto": f"{hf_link}_sft-kto_pythia1-4b", "csft": f"{hf_link}_csft_pythia1-4b", "sft+csft": f"{hf_link}_sft-csft_pythia1-4b"},
    "pythia2-8b" : {"ppo": f"{hf_link}_ppo_pythia2-8b", "dpo": f"{hf_link}_dpo_pythia2-8b", "kto": f"{hf_link}_kto_pythia2-8b", "sft": f"{hf_link}_sft_pythia2-8b", "slic": f"{hf_link}_slic_pythia2-8b", "sft+ppo": f"{hf_link}_sft-ppo_pythia2-8b", "sft+dpo": f"{hf_link}_sft-dpo_pythia2-8b", "sft+kto": f"{hf_link}_sft-kto_pythia2-8b", "csft": f"{hf_link}_csft_pythia2-8b", "sft+csft": f"{hf_link}_sft-csft_pythia2-8b"},
    "pythia6-9b" : {"ppo": f"{hf_link}_ppo_pythia6-9b", "dpo": f"{hf_link}_dpo_pythia6-9b", "kto": f"{hf_link}_kto_pythia6-9b", "sft": f"{hf_link}_sft_pythia6-9b", "slic": f"{hf_link}_slic_pythia6-9b", "sft+ppo": f"{hf_link}_sft-ppo_pythia6-9b", "sft+dpo": f"{hf_link}_sft-dpo_pythia6-9b", "sft+kto": f"{hf_link}_sft-kto_pythia6-9b", "csft": f"{hf_link}_csft_pythia6-9b", "sft+csft": f"{hf_link}_sft-csft_pythia6-9b"},
    "pythia12-0b" : {"ppo": f"{hf_link}_ppo_pythia12-0b", "dpo": f"{hf_link}_dpo_pythia12-0b", "kto": f"{hf_link}_kto_pythia12-0b", "sft": f"{hf_link}_sft_pythia12-0b", "slic": f"{hf_link}_slic_pythia12-0b", "sft+ppo": f"{hf_link}_sft-ppo_pythia12-0b", "sft+dpo": f"{hf_link}_sft-dpo_pythia12-0b", "sft+kto": f"{hf_link}_sft-kto_pythia12-0b", "csft": f"{hf_link}_csft_pythia12-0b", "sft+csft": f"{hf_link}_sft-csft_pythia12-0b"},
    "llama7b" : {"ppo": f"{hf_link}_ppo_llama7b", "dpo": f"{hf_link}_dpo_llama7b", "kto": f"{hf_link}_kto_llama7b", "sft": f"{hf_link}_sft_llama7b", "slic": f"{hf_link}_slic_llama7b", "sft+ppo": f"{hf_link}_sft-ppo_llama7b", "sft+dpo": f"{hf_link}_sft-dpo_llama7b", "sft+kto": f"{hf_link}_sft-kto_llama7b", "csft": f"{hf_link}_csft_llama7b", "sft+csft": f"{hf_link}_sft-csft_llama7b"},
    "llama13b" : {"ppo": f"{hf_link}_ppo_llama13b", "dpo": f"{hf_link}_dpo_llama13b", "kto": f"{hf_link}_kto_llama13b", "sft": f"{hf_link}_sft_llama13b", "slic": f"{hf_link}_slic_llama13b", "sft+ppo": f"{hf_link}_sft-ppo_llama13b", "sft+dpo": f"{hf_link}_sft-dpo_llama13b", "sft+kto": f"{hf_link}_sft-kto_llama13b", "csft": f"{hf_link}_csft_llama13b", "sft+csft": f"{hf_link}_sft-csft_llama13b"},
    "llama30b" : {"ppo": f"{hf_link}_ppo_llama30b", "dpo": f"{hf_link}_dpo_llama30b", "kto": f"{hf_link}_kto_llama30b", "sft": f"{hf_link}_sft_llama30b", "slic": f"{hf_link}_slic_llama30b", "sft+ppo": f"{hf_link}_sft-ppo_llama30b", "sft+dpo": f"{hf_link}_sft-dpo_llama30b", "sft+kto": f"{hf_link}_sft-kto_llama30b", "csft": f"{hf_link}_csft_llama30b", "sft+csft": f"{hf_link}_sft-csft_llama30b"},
}]
