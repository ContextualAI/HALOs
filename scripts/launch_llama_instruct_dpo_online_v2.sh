...
#SBATCH --output=logs/llama-odpo-v2-%j.out
#SBATCH --error=logs/llama-odpo-v2-%j.err
...
export CACHE_DIR=/scratch/gpfs/sl2998/models/llama-instruct-dpo-online-prompt-v2
...
while [ \$CUMULATIVE_PROMPTS -lt ${TOTAL_PROMPTS} ]; do
    ...
    if [ \$PYTHON_EXIT_CODE -eq 0 ]; then
        ...
        EXP_NAME=llama3-8B-instruct-dpo-prompt-v2-\${CUMULATIVE_PROMPTS}
