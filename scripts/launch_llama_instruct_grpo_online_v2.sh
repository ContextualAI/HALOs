#!/bin/bash
#SBATCH --job-name=llama-ogrpo-v2
#SBATCH --nodes=1
#SBATCH --mem=100G
...
#SBATCH --output=logs/llama-ogrpo-v2-%j.out
#SBATCH --error=logs/llama-ogrpo-v2-%j.err
...
export CACHE_DIR=/scratch/gpfs/sl2998/models/llama-instruct-grpo-online-prompt-v2
