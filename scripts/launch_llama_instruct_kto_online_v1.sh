...
#SBATCH --output=logs/llama-okto-v1-%j.out
#SBATCH --error=logs/llama-okto-v1-%j.err
...
export CACHE_DIR=/scratch/gpfs/sl2998/models/llama-instruct-kto-online-prompt-v1
