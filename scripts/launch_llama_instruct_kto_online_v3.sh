...
#SBATCH --output=logs/llama-okto-v3-%j.out
#SBATCH --error=logs/llama-okto-v3-%j.err
...
export CACHE_DIR=/scratch/gpfs/sl2998/models/llama-instruct-kto-online-prompt-v3
