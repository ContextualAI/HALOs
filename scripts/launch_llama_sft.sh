...
export CKPT=/scratch/gpfs/ke7953/models/llama3-8B-sft/FINAL
...
accelerate launch \
    ...
    launch.py loss=sft model=llama train_datasets=[ultrabin] test_datasets=[ultrabin] exp_name=llama3-8B-sft \
...
python -m train.sample \$CKPT --gpu_count 2 --output_file outputs/llama3-8b-sft.json
"